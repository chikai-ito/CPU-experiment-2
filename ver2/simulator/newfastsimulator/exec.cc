...
void exec_normal_code(unsigned int code, int pc, unsigned int* reg, float* freg, int* now, unsigned int* mem, unsigned int* inst_mem, pair<string,int>* label_list,int array_num){
  switch(code >> 26){
